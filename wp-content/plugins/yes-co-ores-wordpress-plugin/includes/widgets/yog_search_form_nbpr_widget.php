  ...
  */
  public function widget($args, $instance)
  {
    ...
    if ($showPrice === true)
    {
      ...
      {
        echo $this->renderElement('Prijs', $this->renderSlider('Prijs', $searchManager->retrieveMinMetaValue(array('yog-nbpr_KoopAanneemSomMin', 'yog-nbpr_HuurPrijsMin'), $params), $maxOption, '&euro; '));
      }
    }
    ...
    if ($showLivingSpace === true)
    {
      ...
      {
        echo $this->renderElement('Woon oppervlakte', $this->renderSlider('WoonOppervlakte', $searchManager->retrieveMinMetaValue('yog-nbpr_WoonOppervlakteMin', $params), $maxOption, '', ' m&sup2;'));
      }
    }
    ...
    if ($showVolume === true)
    {
      ...
      {
        echo $this->renderElement('Inhoud', $this->renderSlider('Inhoud', $searchManager->retrieveMinMetaValue('yog-nbpr_InhoudMin', $params), $maxOption, '', ' m&sup3;'));
      }
    }
